...
const TeachDetails = () => {
  ...
  const Password = localStorage.getItem("TeachPassword");
  const userName = localStorage.getItem("TeachEmail");
  useEffect(() => {
  ...
  const handleLog = () => {
    localStorage.removeItem("Gototeach");
    navigate("/TeachLogin");
  };
  return (
    <>
        ...
        >
          <div style={{ width: "50%" }}>
            ...
            <div style={{ display: "flex", gap: "20px" }}>
              ...
              >
                <img
                  src="https://static.vecteezy.com/system/resources/thumbnails/000/899/311/small/teacher-portrait.jpg"
                  alt=""
                />
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: "10px", margin: "10px" }}>
              <h2 style={{ fontSize: "25px", color: "white" }}>Salary :</h2>
              <h3 style={{ fontSize: "25px", color: "white" }}>
                {formData.salary}
              </h3>
            </div>
